...
- [MkDocs](https://www.mkdocs.org)<!--{target=_blank} comment for docusaurus compat--> with the [Materials theme](https://squidfunk.github.io/mkdocs-material/)<!--{target=_blank} comment for docusaurus compat-->
- [CSpell](https://cspell.org/)<!--{target=_blank} comment for docusaurus compat-->
- [linkchecker](https://linkchecker.github.io/linkchecker/)<!--{target=_blank} comment for docusaurus compat-->
- [Node.js](https://nodejs.org/en/)<!--{target=_blank} comment for docusaurus compat-->
- [Python 3](https://www.python.org)<!--{target=_blank} comment for docusaurus compat-->
